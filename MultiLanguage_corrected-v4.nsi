...
;General
  ...
  ;Name and file
  Name "e-Sword Modulos"
  OutFile "e-Sword Modulos.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\e-Sword"

  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\e-Sword Modulos" ""
...
;Language Selection Dialog Settings
  ...
  !define MUI_LANGDLL_REGISTRY_KEY "Software\e-Sword Modulos"
...
Section "Dummy Section" SecDummy
  ...
  WriteRegStr HKCU "Software\e-Sword Modulos" "" $INSTDIR
...
Section "Install Modules" SecInstallModules
  SetOutPath "C:\Program Files\e-Sword\"
  File /r "modulos\*.*"
SectionEnd
...
Section "Uninstall"
  ...
  DeleteRegKey /ifempty HKCU "Software\e-Sword Modulos"
